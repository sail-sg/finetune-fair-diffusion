...
| Finetune | Logs |
|-----------------|-----------------|
| text encoder | <img src="../_github-images/exp-4-text-encoder/train_DAL_gender.png" alt="train_DAL" width="180"> <img src="../_github-images/exp-4-text-encoder/train_DAL_race.png" alt="train_DAL" width="180"> <img src="../_github-images/exp-4-text-encoder/train_DAL_age.png" alt="train_DAL" width="180"> <br> <img src="../_github-images/exp-4-text-encoder/train_gender_bias.png" alt="train_DAL" width="180"> <img src="../_github-images/exp-4-text-encoder/train_race_bias.png" alt="train_DAL" width="180"> <img src="../_github-images/exp-4-text-encoder/train_gender_race_bias.png" alt="train_DAL" width="180"> <img src="../_github-images/exp-4-text-encoder/train_age_bias.png" alt="train_DAL" width="180"> <br> <img src="../_github-images/exp-4-text-encoder/val_gender_bias.png" alt="train_DAL" width="180"> <img src="../_github-images/exp-4-text-encoder/val_race_bias.png" alt="train_DAL" width="180"> <img src="../_github-images/exp-4-text-encoder/val_gender_race_bias.png" alt="train_DAL" width="180"> <img src="../_github-images/exp-4-text-encoder/val_age_bias.png" alt="train_DAL" width="180"> |
