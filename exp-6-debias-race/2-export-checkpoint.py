...
# python 2-export-checkpoint.py --config configs/debias-text-encoder.yaml --resume_from_checkpoint ./outputs/from-paper_finetune-text-encoder_09190215/checkpoint-9800
# python 2-export-checkpoint.py --config configs/debias-text-encoder-and-unet.yaml --resume_from_checkpoint ./outputs/from-paper_finetune-text-encoder-and-unet_09201743/checkpoint-9000
# python 2-export-checkpoint.py --config configs/debias-unet.yaml --resume_from_checkpoint ./outputs/from-paper_finetune-unet_09210552/checkpoint-6200